...
$expression_data_samples_map is a KBaseExpression.expression_data_samples_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
ExpressionDataSample is a reference to a hash where the following keys are defined:
	sample_id has a value which is a KBaseExpression.sample_id
	...
	sample_type has a value which is a KBaseExpression.sample_type
	...
	strain_id has a value which is a KBaseExpression.strain_id
	...
	experimental_unit_id has a value which is a KBaseExpression.experimental_unit_id
	experiment_meta_id has a value which is a KBaseExpression.experiment_meta_id
	...
	sample_annotations has a value which is a KBaseExpression.sample_annotations
	series_ids has a value which is a KBaseExpression.series_ids
	person_ids has a value which is a KBaseExpression.person_ids
	sample_ids_averaged_from has a value which is a KBaseExpression.sample_ids_averaged_from
	data_expression_levels_for_sample has a value which is a KBaseExpression.data_expression_levels_for_sample
sample_type is a string
strain_id is a string
genome_id is a string
experimental_unit_id is a string
experiment_meta_id is a string
sample_annotations is a reference to a list where each element is a KBaseExpression.SampleAnnotation
SampleAnnotation is a reference to a hash where the following keys are defined:
	sample_annotation_id has a value which is a KBaseExpression.sample_annotation_id
	ontology_id has a value which is a KBaseExpression.ontology_id
	ontology_name has a value which is a KBaseExpression.ontology_name
	ontology_definition has a value which is a KBaseExpression.ontology_definition
sample_annotation_id is a string
ontology_id is a string
ontology_name is a string
ontology_definition is a string
series_ids is a reference to a list where each element is a KBaseExpression.series_id
series_id is a string
person_ids is a reference to a list where each element is a KBaseExpression.person_id
person_id is a string
sample_ids_averaged_from is a reference to a list where each element is a KBaseExpression.sample_id
data_expression_levels_for_sample is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.measurement
...
feature_id is a string
label_data_mapping is a reference to a hash where the key is a string and the value is a KBaseExpression.data_expression_levels_for_sample
data_expression_levels_for_sample is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.measurement
measurement is a float
...
<pre>
$series_ids is a KBaseExpression.series_ids
$series_expression_data_samples_mapping is a KBaseExpression.series_expression_data_samples_mapping
series_ids is a reference to a list where each element is a KBaseExpression.series_id
series_id is a string
series_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.series_id and the value is a KBaseExpression.expression_data_samples_map
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
ExpressionDataSample is a reference to a hash where the following keys are defined:
	sample_id has a value which is a KBaseExpression.sample_id
...
<pre>
$experimental_unit_ids is a KBaseExpression.experimental_unit_ids
$experimental_unit_expression_data_samples_mapping is a KBaseExpression.experimental_unit_expression_data_samples_mapping
experimental_unit_ids is a reference to a list where each element is a KBaseExpression.experimental_unit_id
experimental_unit_id is a string
experimental_unit_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.experimental_unit_id and the value is a KBaseExpression.expression_data_samples_map
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
ExpressionDataSample is a reference to a hash where the following keys are defined:
	sample_id has a value which is a KBaseExpression.sample_id
...
<pre>
$experiment_meta_ids is a KBaseExpression.experiment_meta_ids
$experiment_meta_expression_data_samples_mapping is a KBaseExpression.experiment_meta_expression_data_samples_mapping
experiment_meta_ids is a reference to a list where each element is a KBaseExpression.experiment_meta_id
experiment_meta_id is a string
experiment_meta_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.experiment_meta_id and the value is a KBaseExpression.experimental_unit_expression_data_samples_mapping
experimental_unit_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.experimental_unit_id and the value is a KBaseExpression.expression_data_samples_map
experimental_unit_id is a string
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
...
<pre>
$strain_ids is a KBaseExpression.strain_ids
$sample_type is a KBaseExpression.sample_type
$strain_expression_data_samples_mapping is a KBaseExpression.strain_expression_data_samples_mapping
strain_ids is a reference to a list where each element is a KBaseExpression.strain_id
strain_id is a string
sample_type is a string
strain_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.strain_id and the value is a KBaseExpression.expression_data_samples_map
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
ExpressionDataSample is a reference to a hash where the following keys are defined:
	sample_id has a value which is a KBaseExpression.sample_id
...
<pre>
$genome_ids is a KBaseExpression.genome_ids
$sample_type is a KBaseExpression.sample_type
$wild_type_only is a KBaseExpression.wild_type_only
$genome_expression_data_samples_mapping is a KBaseExpression.genome_expression_data_samples_mapping
genome_ids is a reference to a list where each element is a KBaseExpression.genome_id
genome_id is a string
sample_type is a string
wild_type_only is an int
genome_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.genome_id and the value is a KBaseExpression.strain_expression_data_samples_mapping
strain_expression_data_samples_mapping is a reference to a hash where the key is a KBaseExpression.strain_id and the value is a KBaseExpression.expression_data_samples_map
strain_id is a string
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
...
<pre>
$ontology_ids is a KBaseExpression.ontology_ids
$and_or is a string
$genome_id is a KBaseExpression.genome_id
$sample_type is a KBaseExpression.sample_type
$wild_type_only is a KBaseExpression.wild_type_only
$ontology_expression_data_sample_mapping is a KBaseExpression.ontology_expression_data_sample_mapping
ontology_ids is a reference to a list where each element is a KBaseExpression.ontology_id
ontology_id is a string
genome_id is a string
sample_type is a string
wild_type_only is an int
ontology_expression_data_sample_mapping is a reference to a hash where the key is a KBaseExpression.ontology_id and the value is a KBaseExpression.expression_data_samples_map
expression_data_samples_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
sample_id is a string
ExpressionDataSample is a reference to a hash where the following keys are defined:
	sample_id has a value which is a KBaseExpression.sample_id
...
$sample_type is a KBaseExpression.sample_type
$wild_type_only is a KBaseExpression.wild_type_only
$feature_sample_measurement_mapping is a KBaseExpression.feature_sample_measurement_mapping
feature_ids is a reference to a list where each element is a KBaseExpression.feature_id
feature_id is a string
sample_type is a string
wild_type_only is an int
feature_sample_measurement_mapping is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.sample_measurement_mapping
sample_measurement_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.measurement
sample_id is a string
measurement is a float
...
<pre>
$numerators_data_mapping is a KBaseExpression.label_data_mapping
$denominators_data_mapping is a KBaseExpression.label_data_mapping
$sample_comparison_mapping is a KBaseExpression.sample_comparison_mapping
label_data_mapping is a reference to a hash where the key is a string and the value is a KBaseExpression.data_expression_levels_for_sample
data_expression_levels_for_sample is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.measurement
feature_id is a string
measurement is a float
sample_comparison_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
sample_id is a string
denominator_sample_comparison is a reference to a hash where the key is a KBaseExpression.comparison_denominator_label and the value is a KBaseExpression.data_sample_comparison
comparison_denominator_label is a string
data_sample_comparison is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.log2_ratio
...
<pre>
$numerator_sample_ids is a KBaseExpression.sample_ids
$sample_comparison_mapping is a KBaseExpression.sample_comparison_mapping
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
sample_comparison_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
...
<pre>
$numerator_sample_ids is a KBaseExpression.sample_ids
$denominator_sample_ids is a KBaseExpression.sample_ids
$sample_comparison_mapping is a KBaseExpression.sample_comparison_mapping
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
sample_comparison_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
...
$on_off_mappings is a KBaseExpression.sample_comparison_mapping
sample_comparison_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
sample_id is a string
denominator_sample_comparison is a reference to a hash where the key is a KBaseExpression.comparison_denominator_label and the value is a KBaseExpression.data_sample_comparison
comparison_denominator_label is a string
...
$count is an int
$top_changers_mappings is a KBaseExpression.sample_comparison_mapping
sample_comparison_mapping is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
sample_id is a string
denominator_sample_comparison is a reference to a hash where the key is a KBaseExpression.comparison_denominator_label and the value is a KBaseExpression.data_sample_comparison
comparison_denominator_label is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_titles_map is a KBaseExpression.samples_string_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_string_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_descriptions_map is a KBaseExpression.samples_string_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_string_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_molecules_map is a KBaseExpression.samples_string_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_string_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_types_map is a KBaseExpression.samples_string_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_string_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_external_source_id_map is a KBaseExpression.samples_string_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_string_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
...
<pre>
$sample_ids is a KBaseExpression.sample_ids
$samples_float_map is a KBaseExpression.samples_float_map
sample_ids is a reference to a list where each element is a KBaseExpression.sample_id
sample_id is a string
samples_float_map is a reference to a hash where the key is a KBaseExpression.sample_id and the value is a float
...
<pre>
$series_ids is a KBaseExpression.series_ids
$series_string_map is a KBaseExpression.series_string_map
series_ids is a reference to a list where each element is a KBaseExpression.series_id
series_id is a string
series_string_map is a reference to a hash where the key is a KBaseExpression.series_id and the value is a string
...
<pre>
$external_source_ids is a KBaseExpression.external_source_ids
$sample_ids is a KBaseExpression.sample_ids
external_source_ids is a reference to a list where each element is a KBaseExpression.external_source_id
...
$gseObject is a KBaseExpression.GseObject
GseObject is a reference to a hash where the following keys are defined:
	...
	gse_samples has a value which is a KBaseExpression.gse_samples
	gse_warnings has a value which is a KBaseExpression.gse_warnings
	gse_errors has a value which is a KBaseExpression.gse_errors
gse_samples is a reference to a hash where the key is a string and the value is a KBaseExpression.GsmObject
GsmObject is a reference to a hash where the following keys are defined:
	...
	gsm_sample_characteristics has a value which is a KBaseExpression.gsm_sample_characteristics
	gsm_protocol has a value which is a string
	gsm_value_type has a value which is a string
	gsm_platform has a value which is a KBaseExpression.GPL
	gsm_contact_people has a value which is a KBaseExpression.contact_people
	gsm_data has a value which is a KBaseExpression.gsm_data
	gsm_feature_mapping_approach has a value which is a string
	ontology_ids has a value which is a KBaseExpression.ontology_ids
	gsm_warning has a value which is a KBaseExpression.gsm_warnings
	gsm_errors has a value which is a KBaseExpression.gsm_errors
...
contact_people is a reference to a hash where the key is a KBaseExpression.contact_email and the value is a KBaseExpression.ContactPerson
contact_email is a string
ContactPerson is a reference to a hash where the following keys are defined:
	contact_first_name has a value which is a KBaseExpression.contact_first_name
	contact_last_name has a value which is a KBaseExpression.contact_last_name
	contact_institution has a value which is a KBaseExpression.contact_institution
contact_first_name is a string
contact_last_name is a string
contact_institution is a string
gsm_data is a reference to a hash where the key is a KBaseExpression.genome_id and the value is a KBaseExpression.GenomeDataGSM
genome_id is a string
GenomeDataGSM is a reference to a hash where the following keys are defined:
	warnings has a value which is a KBaseExpression.gsm_data_warnings
	errors has a value which is a KBaseExpression.gsm_data_errors
	features has a value which is a KBaseExpression.gsm_data_set
...
gsm_data_set is a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.FullMeasurement
feature_id is a string
...
<pre>
a reference to a list where each element is a KBaseExpression.feature_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.sample_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.series_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.experiment_meta_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.experimental_unit_id
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.sample_id and the value is a string
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.sample_id and the value is a float
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.series_id and the value is a string
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.measurement
</pre>
...
<pre>
a reference to a hash where the key is a string and the value is a KBaseExpression.data_expression_levels_for_sample
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.log2_ratio
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.comparison_denominator_label and the value is a KBaseExpression.data_sample_comparison
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.denominator_sample_comparison
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.ontology_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.SampleAnnotation
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.external_source_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.person_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.strain_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.genome_id
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.ExpressionDataSample
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.series_id and the value is a KBaseExpression.expression_data_samples_map
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.experimental_unit_id and the value is a KBaseExpression.expression_data_samples_map
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.experiment_meta_id and the value is a KBaseExpression.experimental_unit_expression_data_samples_mapping
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.strain_id and the value is a KBaseExpression.expression_data_samples_map
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.genome_id and the value is a KBaseExpression.strain_expression_data_samples_mapping
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.ontology_id and the value is a KBaseExpression.expression_data_samples_map
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.sample_id and the value is a KBaseExpression.measurement
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.sample_measurement_mapping
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.contact_email and the value is a KBaseExpression.ContactPerson
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.feature_id and the value is a KBaseExpression.FullMeasurement
</pre>
...
<pre>
a reference to a hash where the key is a KBaseExpression.genome_id and the value is a KBaseExpression.GenomeDataGSM
</pre>
...
<pre>
a reference to a hash where the key is a string and the value is a KBaseExpression.GsmObject
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.ExpressionOntologyTerm
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.expression_sample_id
</pre>
...
<pre>
a reference to a list where each element is a KBaseExpression.Person
</pre>
...
id has a value which is a string
source_id has a value which is a string
type has a value which is a KBaseExpression.sample_type
...
averaged_from_samples has a value which is a KBaseExpression.expression_sample_ids
protocol has a value which is a KBaseExpression.Protocol
strain has a value which is a KBaseExpression.Strain
...
id has a value which is a string
source_id has a value which is a string
genome_expression_sample_ids_map has a value which is a KBaseExpression.genome_expression_sample_ids_map
title has a value which is a string
