package Bio::KBase::ExpressionServices::Client;
...
Bio::KBase::ExpressionServices::Client
...
sub new
{
    ...
    my $self = {
	client => Bio::KBase::ExpressionServices::Client::RpcClient->new,
	url => $url,
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for Bio::KBase::ExpressionServices::Client\n";
    }
    if ($sMajor == 0) {
        warn "Bio::KBase::ExpressionServices::Client version is $svr_version. API subject to change.\n";
    }
}
...
package Bio::KBase::ExpressionServices::Client::RpcClient;
